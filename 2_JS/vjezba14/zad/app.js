...
function* tijekUpoznavanja() {
    ...
    // 2. KORAK: Tražimo godine (koristimo 'ime' dobiveno iz prethodnog koraka)
    const godina = yield { 
    ...
    // 3. KORAK: Tražimo grad (koristimo 'ime' i dobiveno iz prethodnog koraka)
    const grad = yield { 
        naslov: `Drago nam je, ${ime} (${godina})!`, 
    ...
    return { 
        ...
        opis: `Pozdrav za ${ime}(${godina}) iz grada ${grad}. Uspješno ste završili proces!`, 
        prikaziUnos: false,
        gotovo: true 
    };
}
